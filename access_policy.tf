...
resource "azurerm_key_vault_access_policy" "terraform_ap" {
...
resource "time_sleep" "wait_30_seconds" {
  depends_on = [azurerm_key_vault_access_policy.terraform_ap, azurerm_key_vault_access_policy.myuser_ap]
